...
namespace SkinnedModelPipeline
{
    ...
    public class SkinnedModelProcessor : ModelProcessor
    {
        ...
        static void MergeAnimation(BoneContent rootBone, NodeContent input, ContentProcessorContext context, string mergeFile)
        {
            if (rootBone == null)
            {
