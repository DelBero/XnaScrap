...
{
    public class GamepadPose3D : AbstractLogic, IPosition3D , IKeyboardListener
    {
        #region member
        ...
        public static void registerElement(IObjectBuilder objectBuilder, IInputManager inputManager)
        {
            ...
            objectBuilder.registerElement(new Constructor(inputManager), sequenceBuilder.CurrentSequence, typeof(GamepadPose3D), "GamepadPose3D", null);
        }
        #endregion
        ...
        public GamepadPose3D(IDataReader state, IInputManager inputManager)
            : base(state)
        {
