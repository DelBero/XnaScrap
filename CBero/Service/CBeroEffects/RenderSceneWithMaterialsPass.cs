...
{
    public class RenderSceneWithMaterialsPass : ICBeroEffectPass
    {
        #region member
        ...
        #endregion
        public RenderSceneWithMaterialsPass(RenderManager renderManager, RenderTargetCollection output)
        {
        ...
        public void draw()
        {
            m_renderManager.renderSceneWithMaterials();
        }
